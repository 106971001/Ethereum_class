...
$('#mineCoinButton').on('click', async function (){
...
$('#transferEtherButton2').on('click', async function (){
	$.post('/transferTo', {
		to: $("#transferEtherTo2").val(),
		value : $("#transferEtherValue2").val(),
		account: nowAccount,
		address: bankAddress
	}, function (result) {
		if (result.events !== undefined) {
